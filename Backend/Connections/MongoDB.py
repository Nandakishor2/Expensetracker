...
mongoDBUserName : str | None = os.getenv("MONGODB_USER")
mongoDBPassword : str | None = os.getenv("MONGODB_PASSWORD")
...
mongoDBClient = MongoClient(url,server_api=ServerApi('1'))
